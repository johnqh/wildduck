...
const { getAddress, isAddress: viemIsAddress, http } = require('viem');
 ...
 */
async function resolveENSOwner(ensName, ethRpcUrl = 'https://eth.llamarpc.com') {
    try {
 ...
 */
async function resolveENSAddress(ensName, ethRpcUrl = 'https://eth.llamarpc.com') {
    try {
