...
module.exports = (db, server, userHandler, settingsHandler) => {
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            if (result.error) {
                logAPI(
                    ...
                    'Validation failed for getAddresses request',
                    {
            ...
            logDB(
                ...
                'Counting addresses for getAddresses'
            );
            ...
            logDB(
                ...
                'Querying addresses collection for getAddresses'
            );
            ...
            try {
                ...
                logError(
                    ...
                    'Failed to query addresses collection'
                );
                res.status(500);
                return res.json({
            ...
            logPerformance(
                ...
                'getAddresses request completed'
            );
            ...
            logAPI(
                ...
                'getAddresses request completed successfully'
            );
    ...
    server.post(
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            // Cannot create customized email addresses with crypto email mode
    ...
    server.del(
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            // Cannot delete email addresses with crypto email mode
            if (tools.runningCryptoEmails()) {
                res.status(400);
                return res.json({
                    error: 'Endpoint not available in crypto emails mode',
