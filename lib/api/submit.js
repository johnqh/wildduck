...
module.exports = (db, server, messageHandler, userHandler, settingsHandler) => {
    ...
    server.post(
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            logAPI('POST', '/users/:user/submit', {
                userId: req.user,
                role: req.role,
                ip: req.ip,
                targetUser: req.params.user,
                isDraft: req.params.isDraft
            }, 'Started submitMessage request');
            ...
            if (result.error) {
                ...
                }, 'Validation failed for submitMessage request', {
            ...
            logPerformance('submitMessage', duration, {
                userId: req.user,
                role: req.role,
                messageId: info.id,
                queueId: info.queueId
