    ...
    server.get(
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            if (result.error) {
                ...
                }, 'Validation failed for updates stream request', {
            ...
            }, 'Finding user data for updates stream');
            ...
            try {
                ...
                logDB('findOne', 'users', {
                    ...
                    role: req.role,
                    found: !!userData
                }, 'Successfully retrieved user data for updates stream');
            } catch (err) {
                logError(err, {
                    userId: req.user,
                    role: req.role,
                    ...
                    targetUser: user.toString()
                }, 'Failed to query users collection for updates stream');
                res.status(500);
                return res.json({
            ...
            let close = () => {
                ...
                logPerformance('getUpdates', duration, {
                    userId: req.user,
                    role: req.role,
                    sessionId: session.id,
                    targetUser: user.toString()
                }, 'Updates stream closed');
            ...
            logAPI('GET', '/users/:user/updates', {
                ...
                sessionId: session.id,
                targetUser: user.toString()
            }, 'Updates stream established successfully');
