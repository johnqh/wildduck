    ...
    async _attemptAutoCreateUser(username, signature, meta) {
        try {
            ...
            if (!indexerUrl) {
                ...
                // For bypass mode, return null to fall through to normal user lookup
                // This avoids complex database operations during bypass
                return null;
            }
        ...
        let defaultMailboxes = [
            {
                ...
                noInferiors: false,
                subscribed: true,
                name: defaults.name || (mailboxTranslations[language] && mailboxTranslations[language].INBOX) || 'Inbox'
            },
            {
                path: 'Sent Mail',
                specialUse: '\\Sent',
