...
const GetUsersResult = Joi.object({
    ...
    username: Joi.string().required().description('Username of the User (blockchain address/ENS/SNS name)'),
    ...
    hasBlockchainAuth: booleanSchema.required().description('If true then the User has blockchain authentication configured'),
